...
const GAME_UPDATES_EXCHANGE = "game-updates"
const DAY_CHUNKS = 8
...
func NewGameUpdateTx(conn *amqp091.Connection, api_id, sim_id uuid.UUID) *GameUpdateTx {
	...
	err = ch.ExchangeDeclare(GAME_UPDATES_EXCHANGE, "topic", false, true, false, false, nil)
...
func (tx *GameUpdateTx) send(ch *amqp091.Channel, update *protos.GameUpdate) {
	...
	err = ch.PublishWithContext(context.Background(),
		GAME_UPDATES_EXCHANGE, // exchange
